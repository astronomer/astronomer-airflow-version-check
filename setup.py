...
setup(
    ...
    package_data={
        ...
        "astronomer.airflow.version_check": ["alembic.ini"],
        "astronomer.airflow.version_check.migrations": ["*"],
        "astronomer.airflow.version_check.migrations.versions": ["*"],
        "astronomer.airflow.version_check.www.dist": ["*"],
    },
